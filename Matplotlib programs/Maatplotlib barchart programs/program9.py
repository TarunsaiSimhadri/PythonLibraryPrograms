...
@Last Modified by: 
@Last Modified time:
@Title : Program to display a bar chart of the popularity of programming languages Increase bottom margin.
...
def bar_chart(Programming_languages, Popularity):
    ...
    description:
        This function is used to display a bar chart of the popularity of programming languages Increase bottom margin.
