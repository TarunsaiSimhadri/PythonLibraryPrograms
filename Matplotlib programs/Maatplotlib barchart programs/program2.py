...
@Last Modified by: 
@Last Modified time:
@Title : Program to display a horizantal bar chart of the popularity of programming languages.
...
def bar_chart(Programming_languages, Popularity):
    ...
    description:
        This function is used to display a horizantal bar chart of the popularity of programming languages.
